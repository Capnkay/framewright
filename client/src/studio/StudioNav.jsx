      ...
      <div className="flex items-center gap-4">
        {!session ? (
          pathname !== '/login' && (
            <Link 
              to="/login" 
              className="rounded-studio-md bg-studio-bg-overlay px-4 py-1.5 text-studio-sm font-medium text-studio-text-primary transition-colors hover:bg-studio-bg-raised"
            >
              Sign in
            </Link>
          )
